...
/**
 * Difference of two cost functions.
 *
 * @author Jochen Guck
 * @author Amaury Van Bemten
 */
public class Minus extends CostModel {
	private CostModel costModel1;
	private CostModel costModel2;

	public Minus(CostModel costModel1, CostModel costModel2) {
	...
	public CostModel init(Controller controller) {
		return new Minus(costModel1.init(controller), costModel2.init(controller));
	}
